...
function DataModellingSection() {
  const cardData = {
    ...
    review:
      "“LearningDeck is an incredibly flexible product, you can build anything on it. It gives you the tools you need to build a CRM that's exactly right to your business, your data, and your processes.",
    name: "Filip Mark",
    ...
    <section>
      <div>
        <CustomHeader
          ...
          description="A CRM should go beyond deals. LearningDeck is built for any business process."
        />
      </div>
